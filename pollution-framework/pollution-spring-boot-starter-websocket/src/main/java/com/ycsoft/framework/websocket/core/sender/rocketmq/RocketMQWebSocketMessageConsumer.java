package com.ycsoft.framework.websocket.core.sender.rocketmq;
...
@RocketMQMessageListener( // 重点：添加 @RocketMQMessageListener 注解，声明消费的 topic
        topic = "${pollution.websocket.sender-rocketmq.topic}",
        consumerGroup = "${pollution.websocket.sender-rocketmq.consumer-group}",
