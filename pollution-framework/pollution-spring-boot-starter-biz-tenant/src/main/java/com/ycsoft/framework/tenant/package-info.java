 ...
 *      1）Spring Async：
 *          {@link com.ycsoft.framework.quartz.config.PollutionAsyncAutoConfiguration#threadPoolTaskExecutorBeanPostProcessor()}
 *      2）Spring Security：
 *          TransmittableThreadLocalSecurityContextHolderStrategy
 *          和 PollutionSecurityAutoConfiguration#securityContextHolderMethodInvokingFactoryBean() 方法
 *
 */
package com.ycsoft.framework.tenant;
