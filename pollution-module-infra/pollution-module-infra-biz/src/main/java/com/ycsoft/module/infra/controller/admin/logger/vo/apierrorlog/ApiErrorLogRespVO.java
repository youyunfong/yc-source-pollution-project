package com.ycsoft.module.infra.controller.admin.logger.vo.apierrorlog;

import com.ycsoft.framework.excel.core.annotations.DictFormat;
import com.ycsoft.framework.excel.core.convert.DictConvert;
import com.ycsoft.module.infra.enums.DictTypeConstants;
...
public class ApiErrorLogRespVO {
    ...
    @DictFormat(com.ycsoft.module.system.enums.DictTypeConstants.USER_TYPE)
