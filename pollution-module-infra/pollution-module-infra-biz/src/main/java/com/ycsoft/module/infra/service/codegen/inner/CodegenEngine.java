package com.ycsoft.module.infra.service.codegen.inner;
...
import com.ycsoft.framework.apilog.core.annotation.ApiAccessLog;
import com.ycsoft.framework.apilog.core.enums.OperateTypeEnum;
...
import com.ycsoft.framework.common.util.date.LocalDateTimeUtils;
import com.ycsoft.framework.common.util.object.BeanUtils;
import com.ycsoft.framework.common.util.object.ObjectUtils;
import com.ycsoft.framework.common.util.string.StrUtils;
import com.ycsoft.framework.excel.core.annotations.DictFormat;
import com.ycsoft.framework.excel.core.convert.DictConvert;
import com.ycsoft.framework.excel.core.util.ExcelUtils;
import com.ycsoft.framework.mybatis.core.dataobject.BaseDO;
...
import com.ycsoft.module.infra.dal.dataobject.codegen.CodegenColumnDO;
import com.ycsoft.module.infra.dal.dataobject.codegen.CodegenTableDO;
import com.ycsoft.module.infra.enums.codegen.CodegenFrontTypeEnum;
import com.ycsoft.module.infra.enums.codegen.CodegenSceneEnum;
import com.ycsoft.module.infra.enums.codegen.CodegenTemplateTypeEnum;
import com.ycsoft.module.infra.framework.codegen.config.CodegenProperties;
...
public class CodegenEngine {
    ...
    private static String javaModuleFilePath(String path, String module, String src) {
        return "pollution-module-${table.moduleName}/" + // 顶级模块
                "pollution-module-${table.moduleName}-" + module + "/" + // 子模块
                "src/" + src + "/java/${basePackage}/module/${table.moduleName}/" + path + ".java";
    }

    private static String mapperXmlFilePath() {
        return "pollution-module-${table.moduleName}/" + // 顶级模块
                "pollution-module-${table.moduleName}-biz/" + // 子模块
    ...
    private static String vueFilePath(String path) {
        return "pollution-ui-${sceneEnum.basePackage}-vue2/" + // 顶级目录
                "src/" + path;
    }
    ...
    private static String vue3FilePath(String path) {
        return "pollution-ui-${sceneEnum.basePackage}-vue3/" + // 顶级目录
                "src/" + path;
    }
