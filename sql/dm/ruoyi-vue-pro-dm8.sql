...
INSERT INTO system_sms_channel (id, signature, code, status, remark, api_key, api_secret, callback_url, creator, create_time, updater, update_time, deleted) VALUES (2, 'Ballcat', 'ALIYUN', 0, '你要改哦，只有我可以用！！！！', 'LTAI_REDACTED2', 'AKSECRET_REDACTED', NULL, '', '2021-03-31 11:53:10', '1', '2024-08-04 08:53:26', '0');
...
INSERT INTO system_tenant (id, name, contact_user_id, contact_name, contact_mobile, status, website, package_id, expire_time, account_count, creator, create_time, updater, update_time, deleted) VALUES (122, '测试租户', 113, '颐川', '15601691300', 0, 'test.iocoder.cn', 111, '2022-04-29 00:00:00', 50, '1', '2022-03-07 21:37:58', '1', '2024-07-20 15:51:18', '0');
COMMIT;
...
INSERT INTO system_users (id, username, password, nickname, remark, dept_id, post_ids, email, mobile, sex, avatar, status, login_ip, login_date, creator, create_time, updater, update_time, deleted, tenant_id) VALUES (1, 'admin', '$2a$10$mRMIYLDtRHlf6.9ipiqH1.Z.bh/R9dO9d5iHiGYPigi6r5KOoR2Wm', '颐川科技', '管理员', 103, '[1,2]', 'aoteman@126.com', '18818260277', 2, 'http://test.pollution.iocoder.cn/bf2002b38950c904243be7c825d3f82e29f25a44526583c3fde2ebdff3a87f75.png', 0, '0:0:0:0:0:0:0:1', '2024-08-26 16:54:00', 'admin', '2021-01-05 17:03:47', NULL, '2024-08-26 16:54:00', '0', 1);
INSERT INTO system_users (id, username, password, nickname, remark, dept_id, post_ids, email, mobile, sex, avatar, status, login_ip, login_date, creator, create_time, updater, update_time, deleted, tenant_id) VALUES (100, 'pollution', '$2a$10$11U48RhyJ5pSBYWSn12AD./ld671.ycSzJHbyrtpeoMeYiw31eo8a', '颐川', '不要吓我', 104, '[1]', 'pollution@iocoder.cn', '15601691300', 1, '', 0, '127.0.0.1', '2022-07-09 23:03:33', '', '2021-01-07 09:07:17', '1', '2024-08-17 11:06:13', '0', 1);
...
-- ----------------------------
-- @formatter:off
SET IDENTITY_INSERT pollution_demo01_contact ON;
...
COMMIT;
SET IDENTITY_INSERT pollution_demo01_contact OFF;
-- @formatter:on
...
-- ----------------------------
-- @formatter:off
SET IDENTITY_INSERT pollution_demo02_category ON;
...
COMMIT;
SET IDENTITY_INSERT pollution_demo02_category OFF;
-- @formatter:on
...
-- ----------------------------
-- @formatter:off
SET IDENTITY_INSERT pollution_demo03_course ON;
...
COMMIT;
SET IDENTITY_INSERT pollution_demo03_course OFF;
-- @formatter:on
...
-- ----------------------------
-- @formatter:off
SET IDENTITY_INSERT pollution_demo03_grade ON;
...
COMMIT;
SET IDENTITY_INSERT pollution_demo03_grade OFF;
-- @formatter:on
...
-- ----------------------------
-- @formatter:off
SET IDENTITY_INSERT pollution_demo03_student ON;
...
COMMIT;
SET IDENTITY_INSERT pollution_demo03_student OFF;
-- @formatter:on
