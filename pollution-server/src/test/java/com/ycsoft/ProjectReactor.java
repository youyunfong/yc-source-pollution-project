...
public class ProjectReactor {
    ...
    private static final String GROUP_ID = "com.ycsoft";
    private static final String ARTIFACT_ID = "pollution";
    private static final String PACKAGE_NAME = "com.ycsoft";
    private static final String TITLE = "面镜污染管理系统";
    ...
    public static void main(String[] args) {
        ...
        // ========== 配置，需要你手动修改 ==========
        String groupIdNew = "com.ycsoft";
        String artifactIdNew = "pollution";
        String packageNameNew = "com.ycsoft";
        String titleNew = "面镜污染管理系统";
        String projectBaseDirNew = "D:\\javaApplication\\javaProcedure\\source-pollution-project"; // 一键改名后，“新”项目所在的目录
