package com.ycsoft.module.system.service.social;
...
import com.ycsoft.framework.common.util.cache.CacheUtils;
import com.ycsoft.framework.common.util.http.HttpUtils;
import com.ycsoft.framework.common.util.object.BeanUtils;
import com.ycsoft.module.system.api.social.dto.SocialWxQrcodeReqDTO;
import com.ycsoft.module.system.api.social.dto.SocialWxaSubscribeMessageSendReqDTO;
import com.ycsoft.module.system.controller.admin.socail.vo.client.SocialClientPageReqVO;
import com.ycsoft.module.system.controller.admin.socail.vo.client.SocialClientSaveReqVO;
import com.ycsoft.module.system.dal.dataobject.social.SocialClientDO;
import com.ycsoft.module.system.dal.mysql.social.SocialClientMapper;
import com.ycsoft.module.system.dal.redis.RedisKeyConstants;
import com.ycsoft.module.system.enums.social.SocialTypeEnum;
...
import static com.ycsoft.framework.common.util.collection.MapUtils.findAndThen;
...
public class SocialClientServiceImpl implements SocialClientService {
     ...
     * 3. developer：开发版
     */
    @Value("${pollution.wxa-code.env-version:release}")
     ...
     * 3. formal：正式版
     */
    @Value("${pollution.wxa-subscribe-message.miniprogram-state:formal}")
