package com.ycsoft.module.system.controller.admin.socail.vo.client;

import cn.hutool.core.util.StrUtil;
import com.ycsoft.framework.common.enums.CommonStatusEnum;
import com.ycsoft.framework.common.enums.UserTypeEnum;
import com.ycsoft.framework.common.validation.InEnum;
...
public class SocialClientSaveReqVO {
    ...
    @Schema(description = "应用名", requiredMode = Schema.RequiredMode.REQUIRED, example = "pollution商城")
